...
class Localizer:
    def __init__(self):
        ...
        self.transformer = Transformer.from_crs(self.crs_wgs84, self.crs_utm, always_xy=True)
        ...
        print(f"Localizer initialized with origin: x={self.origin_x:.3f}, y={self.origin_y:.3f}, undulation={self.undulation:.3f}")
    ...
    def transform_coordinates(self, msg):
        ...
        # print(f"Localizer callback -> x={x:.3f} y={y:.3f}")
        ...
        corrected_azimuth = math.radians(msg.azimuth - azimuth_correction)
